...
#SBATCH --job-name=llama_moe_static_datasize
...
{
    task_name="llama_moe_static_datasize"
    model_type="auto"
    ...
    comment="llama-moe 2/8, four type mix, static sampling by datasize, 4 gpus, eval_steps 100, max_eval_steps 5, w/ balance loss, w/ freeze gate, w/ gate noise"
    base_dir="outputs"
