...
#SBATCH --job-name=llama_moe_static_gate_load
...
{
    task_name="llama_moe_static_gate_load"
    model_type="auto"
    ...
    comment="llama-moe 2/8, sharegpt, 4 gpus, eval_steps 100, max_eval_steps 5, w/ balance loss, w/ freeze gate, w/ gate noise"
    base_dir="outputs"
    ...
    --rdzv_endpoint $head_node:29522 \
        -m src.core.train \
            --do_train True \
            --freeze_gate True \
            --prob_map conf/prob_map/gate_load.json \
