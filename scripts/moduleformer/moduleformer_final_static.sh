...
#SBATCH --job-name=moduleformer_final_static
...
{
    task_name="moduleformer_final_static"
    model_type="auto"
    ...
    --rdzv_endpoint $head_node:29522 \
        -m src.core.train \
            ...
            --do_eval \
            --freeze_gate True \
            --prob_map conf/prob_map/moduleformer_dynamic_final.json \
            --attn_impl eager \
