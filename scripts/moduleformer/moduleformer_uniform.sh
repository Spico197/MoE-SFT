...
#SBATCH --job-name=moduleformer_uniform_eval
...
{
    task_name="moduleformer_uniform"
    model_type="auto"
    # model_name_or_path="/mnt/petrelfs/zhutong/llama-moe-models/MoLM-700M-4B"
    model_name_or_path="outputs//moduleformer_uniform/2516074"
    ...
    --rdzv_endpoint $head_node:29522 \
        -m src.core.train \
            ...
            --deepspeed conf/ds_bf16_zero3.json \
            --bf16 True \
            --tf32 True \
