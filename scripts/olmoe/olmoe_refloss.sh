...
{
    task_name="olmoe_refloss"
    model_type="auto"
    model_name_or_path="data/llama-moe-models/OLMoE-1B-7B-0924"
    dataset_dir_or_path="data/four_types_mix/train"
    eval_data_dir="data/four_types_mix/dev"

    comment="olmoe 8/64, four type mix, dynamic baseline, 4 gpus, eval_steps 100, max_eval_steps 5, w/ balance loss, w/ freeze gate, w/ gate noise"
    base_dir="outputs"
    ...
    --rdzv_endpoint $head_node:29522 \
        -m src.core.train \
            ...
            --dynamic_sampling_name2ref_loss conf/ref_loss/olmoe_uniform.json \
            --dynamic_eta 1.0 \
            --dynamic_c 1e-4 \
