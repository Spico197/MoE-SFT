...
#SBATCH --job-name=olmoe_datasize
...
#SBATCH --nodes=1
##SBATCH --gres=gpu:4
#SBATCH -w SH-IDCA1404-10-140-54-51
...

{
    ...
    comment="olmoe 8/64, four type mix, static sampling by datasize, 4 gpus, eval_steps 100, max_eval_steps 5, w/ balance loss, w/ freeze gate, w/ gate noise"
    base_dir="outputs"
    ...
    --rdzv_endpoint $head_node:29522 \
        -m src.core.train \
            --do_train \
            --freeze_gate True \
            --prob_map conf/prob_map/datasize.json \
